...
public class MainActivity extends AppCompatActivity {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (gameState[index] == 2 && !isGameOver()) {
                        ...
                        String statusText = playerXTurn ? "Player A's Turn" : "Player O's Turn";
    ...
    private void checkForWinner(TextView gameStatus) {
        for (int[] winningPosition : winningPositions) {
            if (gameState[winningPosition[0]] == gameState[winningPosition[1]] &&
                ...
                String winner = gameState[winningPosition[0]] == 1 ? "A" : "O";
    ...
    private void resetGame(GridLayout gridLayout, TextView gameStatus) {
        ...
        playerXTurn = true;
        gameStatus.setText("Player A's Turn");
    }
}
